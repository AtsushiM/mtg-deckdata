...
var AbstractTask, Async, Class, Composite, Composite_bubble, Composite_event, Composite_exeCallback, Composite_preventDefault, Composite_removeChildExe, Composite_stopPropagation, EMPTY, FALSE, LocalStorage, Model, NULL, NULLOBJ, SessionStorage, Storage, Sync, TRUE, WebStorage, bindOnProp, classExtend, classExtendComposite, class_fnTest, class_initializing, copyArray, deleteArrayKey, emit_complete, emit_nexttask, emit_progress, emit_start, hasDeclaredArgument, isArray, isDefined, isFunction, isNumber, isObject, isString, jsonParse, jsonStringify, ns, proxy, required_obj, toArray, win, _is,
